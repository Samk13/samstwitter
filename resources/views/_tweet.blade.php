<div class="p-4 {{ $loop->last ? '':'border-b border-gray-400' }}">
    ...
    <div class="flex space-x-4 ml-2">
        <div class="flex items-center space-x-2 mt-4">
            <svg viewBox="0 0 20 20" version="1.1" class="text-blue-500 w-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="text-blue-500 text-md mt-3">
                {{ $tweet->likes ?: 0 }}
            </span>
        </div>
        <div class="flex items-center space-x-2 mt-4">
            <svg class="text-blue-500 w-6" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="icon-shape" class="fill-current">
